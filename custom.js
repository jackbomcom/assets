(() => {
    ...
    const customizeSidebar = async (isMobile, isHomePage, isUserLoggedIn) => {
      ...
      `;
            ...
            const headerButtons = `
      	<a class="header-custom-button custom ${isUserLoggedIn === true ? "logged-in" : ""} d-flex px-3 align-items-center text-white" href="https://jackbomtv18.com/" target="_blank">
